...
void TestOP()
{
    ...
    printf("冒泡排序 BubbleSort: %.4f\n", (double)(end7 - begin7) / 1000);
    printf("插入排序 InsertSort: %.4f\n", (double)(end1 - begin1) / 1000);
    printf("希尔排序 ShellSort:  %.4f\n", (double)(end2 - begin2) / 1000);
    printf("选择排序 SelectSort: %.4f\n", (double)(end3 - begin3) / 1000);
    printf("堆排序   HeapSort：  %.4f\n", (double)(end4 - begin4) / 1000);
    printf("快速排序 QuickSort:  %.4f\n", (double)(end5 - begin5) / 1000);
    printf("归并排序 MergeSort:  %.4f\n", (double)(end6 - begin6) / 1000);
    free(a1);
    free(a2);
    free(a3);
    free(a4);
